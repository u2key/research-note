...
## 4. IEEE 802.11 Project using MATLAB / Simulink
### 4.1. Import WLAN HDL Transmitter Example
```
openExample('whdl/WLANHDLTransmitterExample', 'workDir', '~/WLANHDLTransmitter')
```

### 4.2. Import WLAN HDL Receiver Example
```
openExample('whdl/WLANHDLReceiverExample', 'workDir', '~/WLANHDLReceiver')
```

### 4.3. Generate HDL Files
#### 4.3.1. Once Run the Project on MATLAB

#### 4.3.2. Open Simulink Top-level File
<div align="center"><img src="imgs/matlab-open-simulink-top-level-file.png" width="500"></div>

#### 4.3.3. Click `Generate HDL Code`

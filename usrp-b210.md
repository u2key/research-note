...
```
```
uhd_image_loader --args="type=b200" --fpga-path="/mnt/c/Users/admin/Documents/VirtualBoxShared/uhd/fpga/usrp3/top/b200/build/usrp_b210_fpga.bin"
```
```
Unit: USRP B210 (340E957)
[INFO] [UHD] linux; GNU C++ version 13.2.0; Boost_108300; UHD_4.6.0.0+ds1-5.1ubuntu0.24.04.1
...
tx_meta.time_spec = usrp_now + uhd.types.TimeSpec(tx_delay)
...
rx_stream_cmd.time_spec = usrp_now + uhd.types.TimeSpec(rx_delay)

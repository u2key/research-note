...
> ```
> ```
> cp -v {/mnt/c/ProgramFiles/boost_1_90_0/lib64-msvc-14.3,/home/ubuntu/uhd/host/build/examples/Release}/boost_program_options-vc143-mt-gd-x64-1_90.dll
> ```
> ```
> cp -v {/mnt/c/ProgramFiles/boost_1_90_0/lib64-msvc-14.3,/home/ubuntu/uhd/host/build/examples/Release}/boost_program_options-vc143-mt-gd-x64-1_90.dll
> ```
...
> ```
> ```
> cp -v {/mnt/c/ProgramFiles/boost_1_90_0/lib64-msvc-14.3,/home/ubuntu/uhd/host/build/examples/Release}/boost_serialization-vc143-mt-gd-x64-1_90.dll
> ```
> ```
...
> ```
> ```
> cp -v {/mnt/c/ProgramFiles/boost_1_90_0/lib64-msvc-14.3,/home/ubuntu/uhd/host/build/examples/Release}/boost_thread-vc143-mt-gd-x64-1_90.dll
> ```
> ```
